...
public class CustomerUpdateDTO {
    ...
    @ValidCustomerPhone(required = false, message = "请输入正确的手机号码")
    private String phone;                   // 对应前端phone字段
    
    @ValidCustomerEmail(required = false, message = "请输入正确的邮箱地址")
    ...
    // 地址信息 - 对应前端address对象
    private AddressUpdateInfo address;
    ...
    // 内部类 - 地址更新信息
    public static class AddressUpdateInfo {
    ...
    public AddressUpdateInfo getAddress() {
        return address;
    }
    
    public void setAddress(AddressUpdateInfo address) {
